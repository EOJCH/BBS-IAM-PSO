...
namespace VVIPUser_Tool
{
    public class APICall
    {
        ...
        public object GetRestApiCall(string routepath,string queryparams)
        {
            ...
            try
            {
                string apiurl = "https://primaqueryservice.bayer-ag.com/IAMRESTService.svc";// ConfigurationManager.AppSettings["PrimaRestApiUrl"];
                string userid = "MXAXX";// ConfigurationManager.AppSettings["UserId"];
                string password = "aSKEiMbzqW#L]DQWs";// ConfigurationManager.AppSettings["ApiPassword"];
                //string userid ="EHGLM";
